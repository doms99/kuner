 ...
 *
 * <p>A {@code FlutterSwipeDismissFrameLayout}'s UI is painted by a corresponding {@link
 * io.flutter.embedding.engine.FlutterEngine}.
 *
 * <p>A {@code FlutterSwipeDismissFrameLayout} can operate in 2 different {@link
 ...
 *       FlutterSwipeDismissFrameLayout} in this mode cannot be positioned between 2 other Android {@code View}s in the
 ...
 *       io.flutter.embedding.android.RenderMode#surface}, but a {@code FlutterSwipeDismissFrameLayout} in this mode
 ...
 */
public class FlutterSwipeDismissFrameLayout extends SwipeDismissFrameLayout
        implements MouseCursorPlugin.MouseCursorViewDelegate, KeyboardManager.ViewDelegate {
  private static final String TAG = "FlutterSwipeDismissFrameLayout";
  ...
  /**
   * Constructs a {@code FlutterSwipeDismissFrameLayout} programmatically, without any XML attributes.
   *
   * <p>
   *
   * <ul>
   ...
   * </ul>
   *
   * {@code FlutterSwipeDismissFrameLayout} requires an {@code Activity} instead of a generic {@code Context} to be
   * compatible with {@link PlatformViewsController}.
   */
  public FlutterSwipeDismissFrameLayout(@NonNull Context context) {
    this(context, null, new FlutterSurfaceView(context));
  }

  /**
   * Deprecated - use {@link #FlutterSwipeDismissFrameLayout(Context, FlutterSurfaceView)} or {@link
   * #FlutterSwipeDismissFrameLayout(Context, FlutterTextureView)} or {@link #FlutterSwipeDismissFrameLayout(Context, FlutterImageView)}
   * instead.
   */
  @Deprecated
  public FlutterSwipeDismissFrameLayout(@NonNull Context context, @NonNull RenderMode renderMode) {
    super(context, null);
  ...
  /**
   * Deprecated - use {@link #FlutterSwipeDismissFrameLayout(Context, FlutterSurfaceView)} or {@link
   * #FlutterSwipeDismissFrameLayout(Context, FlutterTextureView)} instead, and configure the incoming {@code
   * FlutterSurfaceView} or {@code FlutterTextureView} for transparency as desired.
   *
   * <p>Constructs a {@code FlutterSwipeDismissFrameLayout} programmatically, without any XML attributes, uses a {@link
   * FlutterSurfaceView} to render the Flutter UI, and allows selection of a {@code
   * transparencyMode}.
   *
   * <p>{@code FlutterSwipeDismissFrameLayout} requires an {@code Activity} instead of a generic {@code Context} to be
   * compatible with {@link PlatformViewsController}.
   */
  @Deprecated
  public FlutterSwipeDismissFrameLayout(@NonNull Context context, @NonNull TransparencyMode transparencyMode) {
    this(
            context,
            null,
  ...
  /**
   * Constructs a {@code FlutterSwipeDismissFrameLayout} programmatically, without any XML attributes, uses the given
   ...
   * compatible with {@link PlatformViewsController}.
   */
  public FlutterSwipeDismissFrameLayout(@NonNull Context context, @NonNull FlutterSurfaceView flutterSurfaceView) {
   ...
   * compatible with {@link PlatformViewsController}.
   */
  public FlutterSwipeDismissFrameLayout(@NonNull Context context, @NonNull FlutterTextureView flutterTextureView) {
   ...
   * compatible with {@link PlatformViewsController}.
   */
  public FlutterSwipeDismissFrameLayout(@NonNull Context context, @NonNull FlutterImageView flutterImageView) {
    this(context, null, flutterImageView);
  }

  /**
   * Constructs a {@code FlutterSwipeDismissFrameLayout} in an XML-inflation-compliant manner.
   *
   * <p>{@code FlutterSwipeDismissFrameLayout} requires an {@code Activity} instead of a generic {@code Context} to be
   * compatible with {@link PlatformViewsController}.
   */
  // TODO(mattcarroll): expose renderMode in XML when build system supports R.attr
  public FlutterSwipeDismissFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
   ...
   */
  @Deprecated
  public FlutterSwipeDismissFrameLayout(
  ...
  private FlutterSwipeDismissFrameLayout(
          @NonNull Context context,
  ...
  private void init() {
    Log.v(TAG, "Initializing FlutterSwipeDismissFrameLayout");
    ...
    // FlutterSwipeDismissFrameLayout needs to be focusable so that the InputMethodManager can interact with it.
    setFocusable(true);
   ...
   * least 1 frame to this {@code FlutterSwipeDismissFrameLayout}.
   *
   ...
   *
   * <ol>
   *   <li>{@code flutterEngineA} is attached to this {@code FlutterSwipeDismissFrameLayout}: returns false
   *   <li>{@code flutterEngineA} renders its first frame to this {@code FlutterSwipeDismissFrameLayout}: returns true
   *   <li>{@code flutterEngineA} is detached from this {@code FlutterSwipeDismissFrameLayout}: returns false
   *   <li>{@code flutterEngineB} is attached to this {@code FlutterSwipeDismissFrameLayout}: returns false
   *   <li>{@code flutterEngineB} renders its first frame to this {@code FlutterSwipeDismissFrameLayout}: returns true
   * </ol>
   */
  ...
  /**
   * Adds the given {@code listener} to this {@code FlutterSwipeDismissFrameLayout}, to be notified upon Flutter's
  ...
  /**
   * Invoked when this {@code FlutterSwipeDismissFrameLayout} changes size, including upon initial measure.
   *
  ...
  protected void onSizeChanged(int width, int height, int oldWidth, int oldHeight) {
    ...
    Log.v(
            TAG,
            "Size changed. Sending Flutter new viewport metrics. FlutterSwipeDismissFrameLayout was "
                    + oldWidth
                    + " x "
                    + oldHeight
                    + ", it is now "
   ...
   * text-input widgets, therefore {@code FlutterSwipeDismissFrameLayout} must support an {@code InputConnection}.
   *
   * <p>The {@code InputConnection} returned from this method comes from a {@link TextInputPlugin},
   * which is owned by this {@code FlutterSwipeDismissFrameLayout}. A {@link TextInputPlugin} exists to encapsulate the
   * nuances of input communication, rather than spread that logic throughout this {@code
   * FlutterSwipeDismissFrameLayout}.
   */
  @Override
  @Nullable
  ...
  /**
   * Connects this {@code FlutterSwipeDismissFrameLayout} to the given {@link
   * io.flutter.embedding.engine.FlutterEngine}.
   *
   * <p>This {@code FlutterSwipeDismissFrameLayout} will begin rendering the UI painted by the given {@link
   * FlutterEngine}. This {@code FlutterSwipeDismissFrameLayout} will also begin forwarding interaction events from
   * this {@code FlutterSwipeDismissFrameLayout} to the given {@link io.flutter.embedding.engine.FlutterEngine}, e.g.,
  ...
  public void attachToFlutterEngine(@NonNull FlutterEngine flutterEngine) {
    ...
    for (FlutterEngineAttachmentListener listener : flutterEngineAttachmentListeners) {
      listener.onFlutterEngineAttachedToFlutterSwipeDismissFrameLayout(flutterEngine);
    }
    ...
    // with a FlutterSwipeDismissFrameLayout that is only partially attached to a FlutterEngine.
  ...
  /**
   * Disconnects this {@code FlutterSwipeDismissFrameLayout} from a previously attached {@link
   * io.flutter.embedding.engine.FlutterEngine}.
   *
   * <p>This {@code FlutterSwipeDismissFrameLayout} will clear its UI and stop forwarding all events to the
  ...
  public void detachFromFlutterEngine() {
    ...
    if (!isAttachedToFlutterEngine()) {
      Log.v(TAG, "FlutterSwipeDismissFrameLayout not attached to an engine. Not detaching.");
      return;
    }

    // Notify engine attachment listeners of the detachment.
    for (FlutterEngineAttachmentListener listener : flutterEngineAttachmentListeners) {
      listener.onFlutterEngineDetachedFromFlutterSwipeDismissFrameLayout();
    }
    ...
    if (flutterImageView != null) {
      ...
      // avoid leaks when this FlutterSwipeDismissFrameLayout is reused later in the scenario where multiple
  ...
  /**
   * Returns true if this {@code FlutterSwipeDismissFrameLayout} is currently attached to a {@link
   * io.flutter.embedding.engine.FlutterEngine}.
   */
  @VisibleForTesting
  ...
  /**
   * Returns the {@link io.flutter.embedding.engine.FlutterEngine} to which this {@code FlutterSwipeDismissFrameLayout}
   * is currently attached, or null if this {@code FlutterSwipeDismissFrameLayout} is not currently attached to a
   ...
   * FlutterSwipeDismissFrameLayout} attached to/detaches from a {@link io.flutter.embedding.engine.FlutterEngine}.
   */
  @VisibleForTesting
    ...
    if (!isAttachedToFlutterEngine()) {
      Log.w(
              ...
              "Tried to send viewport metrics from Android to Flutter but this "
                      + "FlutterSwipeDismissFrameLayout was not attached to a FlutterEngine.");
      return;
    }
   ...
   * to/detached from a given {@code FlutterSwipeDismissFrameLayout}.
   */
  @VisibleForTesting
  public interface FlutterEngineAttachmentListener {
    /** The given {@code engine} has been attached to the associated {@code FlutterSwipeDismissFrameLayout}. */
    void onFlutterEngineAttachedToFlutterSwipeDismissFrameLayout(@NonNull FlutterEngine engine);

    /**
     * A previously attached {@link io.flutter.embedding.engine.FlutterEngine} has been detached
     * from the associated {@code FlutterSwipeDismissFrameLayout}.
     */
    void onFlutterEngineDetachedFromFlutterSwipeDismissFrameLayout();
  }
}
