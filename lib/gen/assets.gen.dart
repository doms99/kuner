...
class $AssetsPngsGen {
  ...
  /// File path: assets/pngs/euro.png
  AssetGenImage get euro => const AssetGenImage('assets/pngs/euro.png');

  /// File path: assets/pngs/kn.png
  AssetGenImage get kn => const AssetGenImage('assets/pngs/kn.png');
}
